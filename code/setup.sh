...
if [ $1 == "9" ] ; then
	...
	wget https://www.dropbox.com/s/dbp4epj0jxuo8o3/driverSetup_902.tar.gz
	...
	wget https://www.dropbox.com/s/tbhku0zn88eogfs/driverSetup_806.tar.gz
	...
	wget https://www.dropbox.com/s/37xmp6v97ceit1y/driverSetup_752.tar.gz
